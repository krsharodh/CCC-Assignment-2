...
function getCallback(callback) {
    return function (word, event) {
        ...
        if (callback === 'onWordClick') {
            fetch("http://127.0.0.1:5000/vaccine/hashtag/get_tweet_by_word", {
            method: 'POST',
            headers: {
...
class WordCloudVaccineHashTag extends Component{
    constructor(props){
        super(props);
        this.state={
            data: []
    ...
    getWordCloud() {
        fetch("http://127.0.0.1:5000/vaccine/hashtag/words_cloud", {
            method: 'POST',
            headers: {
    ...
    render() {
        return (
            <div>
                <span>Word Cloud of Top frequent hashtags in vaccine-related tweets</span>
...
export default WordCloudVaccineHashTag;
